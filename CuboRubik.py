...
print("")
print("")
print(f"{MAGENTA} Dirijase a la ventana de vista previa para realizar el escaneao de cada lado y qué color debe estar en el centro de cada lado. ")
        ...
        if k == 27:
            ...
            if len(set(check_state))==6:    
                try:
                    ...
                    print("error en la detección lateral, es posible que no siga la secuencia o que algún color no se detecte bien. Inténtelo de nuevo")
            else:
                print("todos los lados no están escaneados. Visite la otra ventana para encontrar cuál queda por escanear")
                print("Escaneo Izquierda:",6-len(set(check_state)))
