...
class detectormanos():
    ...
    def encontrarposicion(self,frame,ManoNum=0,dibujar=True):
        ...
        if self.resultados.multi_hand_landmarks:
            ...
            for id,lm in enumerate(miMano.landmark):
                ...
                cx,cy=int(lm.x*ancho),int(lm.y*alto)# Convertimos en pixeles
                xlista.append(cx)
                ylista.append(cy)
            ...
            if dibujar:
                cv2.rectagle(frame,(xmin-20,ymin-20),(xmax+20,ymax+20),(0,255,0),2)
    ...
    def distancia(self,p1,p2,frame,dibujar=True,r=15,t=3):
        ...
        if dibujar:
            ...
            cv2.circle(frame,(x1,y2),r,(0,0,255),cv2.FILLED)
